const Jobs = {
    MARE_NOSTRUM: '<h4>Cross-Platform App Dev Student <a href="https://portal.edu.gva.es/iesmarenostrum/es/centre/">@ IES Mare Nostrum</a></h4><h5>Sep 2019 - Jun 2021</h5><br><p>→ OOP (Java/C#, Netbeans/IntelliJ/Visual Studio)<br><br>→ Database design/implementation (Microsoft SQL Server 2017), Data Access<br><br>→ ERPs & CRMs<br><br>→ Work in a web app prototype to read/write books online (Node.js/Express/React)</p>',
