const Jobs = {
    ...
    VSN: '<h4>Student Intern <a href="https://www.vsn-tv.com/en/">@ Video Stream Networks</a></h4><h5>Oct 2018 - Dec 2018, Mar 2021 - Present</h5><br><p>→ Debug code for a online video editor platform (TypeScript/React)<br><br>→ System setup (Windows Server 2016, Active Directory, Microservice setup, SQL Server...)<br><br>→ Work in a video file testing project with custom user config (C#, .NET)<br><br>→ Enjoy daily meetings with experienced software engineers</p>'
};
